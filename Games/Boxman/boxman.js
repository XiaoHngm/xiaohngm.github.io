...
window.addEventListener("load",function(){
    ...
    Q.component("boxManControls", {
        ...
        step: function(dt){
            ...
            //判断按下的键盘按键来控制玩家对象的方向
            if(Q.inputs['left'] == true) {          //当左箭头键按下时
                p.direction = 'left';
            } else if(Q.inputs['right'] == true) {  //当右箭头键按下时
                p.direction = 'right';
            } else if(Q.inputs['up'] == true) {     //当上箭头键按下时
                p.direction = 'up';
            } else if(Q.inputs['down'] == true) {   //当下箭头键按下时
                p.direction = 'down';
            } else { //什么事都没做时
                p.direction = 'nothing';
            }
    ...
    Q.Sprite.extend("Player", {
        ...
        step: function(dt) {
            if(Q.inputs['left'] || Q.inputs['right'] ||
               Q.inputs['up']   || Q.inputs['down']) {  //当按下左右上下箭头键就播放玩家走路动画
